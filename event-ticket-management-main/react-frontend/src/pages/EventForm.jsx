...
export default function EventForm() {
  ...
  useEffect(() => {
    ...
    if (!isAuthorized) {
      navigate('/register?role=ORGANIZER&notice=' + encodeURIComponent('To host an event, you have to log in as an organizer.'));
      return;
    }
    if (id) {
      fetchEventData();
    }
  }, [user, isAuthorized, id, navigate, fetchEventData]);
