...
export default function Register() {
  ...
  const requestedRole = searchParams.get('role')?.toUpperCase() === 'ORGANIZER' ? 'ORGANIZER' : 'USER';
  const notice = searchParams.get('notice') || searchParams.get('msg');
  ...
  return (
    <div className="min-h-[85vh] w-full flex items-center justify-center px-4 sm:px-6 lg:px-8 py-16 relative overflow-hidden bg-[#070709]">
      ...
      <div className="relative z-10 w-full max-w-lg bg-[#0e0f16] border border-white/15 p-8 sm:p-10 shadow-2xl space-y-8">
        ...
        {notice && (
          <div className="p-3.5 bg-yellow-500/15 border border-yellow-500/40 text-yellow-300 font-mono text-xs flex items-center gap-2">
        ...
        {/* Footer info */}
        <div className="pt-6 border-t border-white/10 space-y-4 text-center font-mono text-xs text-gray-400">
          <a
            href="http://localhost:8080/oauth2/authorization/google"
            className="w-full flex items-center justify-center gap-2 py-3 border border-white/20 text-white hover:border-[#ccff00] hover:text-[#ccff00] transition-all text-xs font-mono uppercase tracking-widest"
          >
            <svg width="16" height="16" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M44.5 20H24v8.5h11.8C34.7 33.9 30.1 37 24 37c-7.2 0-13-5.8-13-13s5.8-13 13-13c3.1 0 5.9 1.1 8.1 2.9l6.4-6.4C34.6 5.1 29.6 3 24 3 12.4 3 3 12.4 3 24s9.4 21 21 21c10.5 0 20-7.6 20-21 0-1.3-.2-2.7-.5-4z" fill="currentColor"/>
            </svg>
            SIGN UP WITH GOOGLE
          </a>
          <div>
